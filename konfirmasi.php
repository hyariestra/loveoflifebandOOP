 		...
 		<div style="background-color: white;padding-top: 15px; padding-left: 10px;padding-right: 10px;padding-bottom: 15px;" class="content-wrapper">
 			<form method="POST" enctype="multipart/form-data">
 				<div class="form-group">
 					...
 					<input type="text" value="<?php echo $info['0']['kode_pembelian'] ?>" class="form-control" name="kode" readonly="">
 					<input type="hidden" value="<?php echo $info['0']['id_pembelian'] ?>" class="form-control" name="id_pembelian" readonly="">
 				</div>
 				<div class="form-group">
 					<label>Total Pembayaran</label>
 					<input type="text" value="Rp. <?php echo number_format($info['0']['total_bayar']); ?>,00" class="form-control" name="nominal" readonly="">
 				</div>
 				<div class="form-group">
 					<label>Bank</label>
...
if (isset($_POST['save']))
{
	$simpan=$pembelian->simpankonfirmasi($_POST['kode'],$_POST['id_pembelian'],$_POST['nominal'],$_POST['bank'],$_POST['nama'],$_POST['tanggal'],$_FILES['gambar']);
